...
function ShadowCash( options ) {

	this.opts = {
		host: options.host ? options.host : 'localhost',
		port: options.port ? options.port : 51737,
		...
		passphrasecallback: options.passphrasecallback ? options.passphrasecallback : null,
		https: options.https ? options.https : false,
		ca: options.ca ? options.ca : null
	};
...
*/
	...
	// write log to file
	winston.add( winston.transports.File, { filename: 'shadowcash-client.log' });
	winston.info('Connecting to coind...');


}

ShadowCash.prototype = {
